    ...
    <View style={{ flex: 1, padding: 16 }}>
      <View style={{ flex: 1 }}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 20 }}>
          <Text style={{ borderColor: '#2560be', borderWidth: 1, borderRadius: 50, padding: '1em', fontSize: '1.2em', width: '35%', textAlign: 'center', marginRight: '0.5em', color: '#2560be' }}>
            Pular
          </Text>

          <Text style={{ backgroundColor: '#2560be', color: 'white', borderWidth: 1, borderRadius: 50, borderColor: '#2560be', fontSize: '1.2em', width: '35%', textAlign: 'center', padding: '1em' }}>
            Pŕoximo
          </Text>
        </View>
      </View>
