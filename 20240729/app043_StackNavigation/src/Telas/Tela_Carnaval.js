...
export default function Tela_Carnaval() {
  ...
  let origens_egito = [ "No Egito Antigo, havia festividades em honra aos deuses, como o Festival de Osíris, que era celebrado com procissões, danças e cantos. Essas celebrações podem ter influenciado os ritos festivos das civilizações mediterrâneas posteriores.",
    "O culto a Ísis, uma das deusas mais importantes do Egito Antigo, foi particularmente influente. Com a expansão do Império Romano, o culto a Ísis se espalhou pela Europa, trazendo consigo elementos de festividades e procissões que eventualmente se integrariam às tradições carnavalescas." ];
      ...
      <View style={ estilos.fundoTelas }>
        <View style={ estilos.telas }>
          <View style={ estilos.cabecalhoTelas }>
            <Image source={ require('../carnaval.jpeg') } style={ estilos.capa_pagina }></Image>

            <View>
              <Text style={ estilos.nome_festa }>Carnaval</Text>
          ...
          <ScrollView style={ estilos.conteudo_telas }>
            ...
            <Text style={[ estilos.titulos, { marginHorizontal: '1rem', marginBottom: '1rem', marginTop: '0.375rem' } ]}>{destaque}</Text>

            <Text style={ estilos.titulos }>Origens</Text>

            <Text style={ estilos.textos_telas }>{origens}</Text>

            <Text style={[ estilos.titulos, { marginBottom: '0.625rem' } ]}>Curiosidades: Egito</Text>

            <Image source={ require('../egito.png') } style={ estilos.images }></Image>

            <Text style={ estilos.textos_telas }>{origens_egito[0]}</Text>

            <Text style={ estilos.textos_telas }>{origens_egito[1]}</Text>

            <Text style={ estilos.titulos }>Influência Cristã</Text>

            <Text style={ estilos.textos_telas }>{influencia_crista}</Text>

            <Text style={ estilos.titulos }>Evolução Medieval</Text>

            <Text style={ estilos.textos_telas }>{evolucao_medieval}</Text>

            <Text style={ estilos.titulos }>Chegada Nas Américas</Text>

            <Text style={ estilos.textos_telas }>{chegada_americas}</Text>

            <Text style={ estilos.titulos }>Atualmente</Text>

            <Text style={ estilos.textos_telas }>{atualmente}</Text>
          </ScrollView>
