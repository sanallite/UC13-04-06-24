/* Aula 19 - Navegação entre telas, Stack Navigation - Desafio 2, Tela do app com o jogo das idols */

import React, { useState } from 'react';
import { styles } from '../src/estilos/usestate';
import { View, Text, Image, TouchableOpacity, FlatList, ScrollView } from 'react-native';
/* Importanto um novo componente, que ainda não aprendi bem. */

function UseState() {
  let talentos = [
    { nome: "Gawr Gura", imagem: require('../src/img/gura.png') },
    { nome: "Ninomae Ina'nis", imagem: require('../src/img/ina.png') },
    { nome: "Takanashi Kiara", imagem: require('../src/img/kiara.png') },
    { nome: 'Mori Calliope', imagem: require('../src/img/mori.png') },
    { nome: 'Amelia Watson', imagem: require('../src/img/ame.png') },
    { nome: 'Irys', imagem: require('../src/img/irys.png') },
    { nome: 'Tsukumo Sana', imagem: require('../src/img/sana.png') },
    { nome: 'Ceres Fauna', imagem: require('../src/img/fauna.png') },
    { nome: 'Ouro Kronni', imagem: require('../src/img/kronni.png') },
    { nome: 'Nanashi Mumei', imagem: require('../src/img/mumei.png') },
    { nome: 'Hakos Baelz', imagem: require('../src/img/baelz.png') },
    { nome: 'Shiori Novella', imagem: require('../src/img/shiori.webp') },
    { nome: 'Koseki Bijou', imagem: require('../src/img/bijou.webp') },
    { nome: 'Nerissa Ravencroft', imagem: require('../src/img/nerissa.webp') },
    { nome: 'Fuwawa Abyssguard', imagem: require('../src/img/fuwawa.webp') },
    { nome: 'Mococo Abyssguard', imagem: require('../src/img/mococo.webp') },
    { nome: 'Elizabeth Rose Bloodflame', imagem: require('../src/img/elizabeth.png') },
    { nome: 'Gigi Murin', imagem: require('../src/img/gigi.png') },
    { nome: 'Cecilia Immergreen', imagem: require('../src/img/cecilia.png') },
    { nome: 'Roara Panthera', imagem: require('../src/img/raora.png') },
  ];
  ...
  const [ imagemTalento, setImagem ] = useState( require('../src/img/yagoo.jpg'));
  ...
  function gacha() {
    if ( textoBotao == "Jogar" ) {
      ...
      setImagem( require('../src/img/yagoo.jpg') );
